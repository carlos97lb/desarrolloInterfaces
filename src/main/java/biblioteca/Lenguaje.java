 ...
 */
public class Lenguaje extends javax.swing.JDialog {

    /**
     * Creates new form Lenguaje
     */
    Frame principal;
    public Lenguaje(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Español", "English", "Français", "German", "Catalan" }));
        ...
        jLabel2.setText("Seleccione su lenguaje:");
        ...
        jpCabeceraLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jpCabeceraLayout.createSequentialGroup()
                .addGap(91, 91, 91)
                .addComponent(JButtonvolver, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE)
                .addGap(98, 98, 98))
        );
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Lenguaje dialog = new Lenguaje(new javax.swing.JFrame(), true);
